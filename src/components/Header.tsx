...
export const Header = () => {
  const {cartQuantity, openCart} = useShoppingContext()
    return <Navbar sticky="top"  className="shadow-md  bg-white mb-5 " >
        <Container>
            <Nav className="me-auto" >
                <Nav.Link to='/Home' as={NavLink} >Home</Nav.Link>
                <Nav.Link to='/Country' as={NavLink} >Country</Nav.Link>
            ...
            {cartQuantity !== 0 && (
                ...
                className="rounded-circle opacity-80 hover:opacity-100"
              >
                <svg
